				...
				<section className="twgtr-px-4 twgtr-py-[25px] md:twgtr-py-[50px]">
					<div className="site-container">
						<div className="twgtr-flex twgtr-flex-col lg:twgtr-flex-row twgtr-border twgtr-border-solid twgtr-border-slate-300 dark:twgtr-border-slate-500 recipe-card">
							<NavLink to={`/view-recipe/${rec1.id}`} title={rec1.recipe_title} className="twgtr-w-full lg:twgtr-w-[calc(100%-500px)] twgtr-bg-no-repeat twgtr-bg-cover twgtr-bg-center" style={{backgroundImage: `url('${rec1.recipe_featured_image}')`}}>
							...
							<div className="twgtr-min-w-0 lg:twgtr-min-w-[500px] twgtr-max-w-auto lg:twgtr-max-w-[500px] twgtr-flex lg:twgtr-justify-center twgtr-flex-col twgtr-p-[20px] lg:twgtr-p-[50px] twgtr-min-h-0 lg:twgtr-min-h-[400px] twgtr-bg-white dark:twgtr-bg-slate-800">
								<div className="lg:twgtr-hidden">
									<div className="twgtr-pb-1">
										<NavLink to={`/view-recipe/${rec1.id}`} title={rec1.recipe_title} className="twgtr-transition-all twgtr-font-ubuntu twgtr-text-[20px] md:twgtr-text-[25px] twgtr-font-semibold twgtr-text-theme-color-4 dark:twgtr-text-slate-200">
											<h2>
												{rec1.recipe_title}
											</h2>
										</NavLink>
								...
								<div className="twgtr-hidden lg:twgtr-block">
									...
									<div className="twgtr-pb-1">
										<NavLink to={`/view-recipe/${rec1.id}`} title={rec1.recipe_title} className="twgtr-font-ubuntu twgtr-text-[20px] md:twgtr-text-[25px] twgtr-font-semibold">
				...
				<section className="twgtr-px-4 twgtr-pt-[25px] twgtr-pb-[50px] md:twgtr-py-[50px]">
					<div className="site-container">
						...
						<div className="twgtr-flex twgtr-flex-col lg:twgtr-flex-row twgtr-gap-[20px] twgtr-flex-wrap">
							<NavLink to={`/view-recipe/${rec2.id}`} title={rec2.recipe_title} className="twgtr-relative recipe-card lg:twgtr-flex-1 twgtr-bg-white dark:twgtr-bg-slate-800 lg:twgtr-min-h-[720px] twgtr-bg-no-repeat twgtr-bg-cover twgtr-bg-center home-after-shadow home-after-shadow-hover after:twgtr-opacity-[0.4]" style={{backgroundImage: `url('${rec2.recipe_featured_image}')`}}>
							...
							<div className="twgtr-flex-1">
								<div className="twgtr-grid twgtr-gap-[20px] twgtr-grid-cols-1 md:twgtr-grid-cols-2">
									...
									<NavLink to={`/view-recipe/${rec5.id}`} title={rec5.recipe_title} className="twgtr-relative recipe-card twgtr-bg-white dark:twgtr-bg-slate-800 twgtr-min-h-[350px] twgtr-bg-no-repeat twgtr-bg-cover twgtr-bg-center home-after-shadow home-after-shadow-hover after:twgtr-opacity-[0.4]" style={{backgroundImage: `url('${rec5.recipe_featured_image}')`}}>
										<div className="twgtr-flex twgtr-flex-col twgtr-min-h-[100%] twgtr-p-[20px] twgtr-relative twgtr-z-[5]">
											<div className="twgtr-mt-auto">
												<h2 className="twgtr-transition-all twgtr-font-ubuntu twgtr-text-[20px] md:twgtr-text-[25px] twgtr-font-semibold twgtr-text-white">
													{rec5.recipe_title}
									...
									<NavLink to={`/view-recipe/${rec6.id}`} title={rec6.recipe_title} className="twgtr-relative recipe-card twgtr-bg-white dark:twgtr-bg-slate-800 twgtr-min-h-[350px] twgtr-bg-no-repeat twgtr-bg-cover twgtr-bg-center home-after-shadow home-after-shadow-hover after:twgtr-opacity-[0.4]" style={{backgroundImage: `url('${rec6.recipe_featured_image}')`}}>
										<div className="twgtr-flex twgtr-flex-col twgtr-min-h-[100%] twgtr-p-[20px] twgtr-relative twgtr-z-[5]">
											<div className="twgtr-mt-auto">
												<h2 className="twgtr-transition-all twgtr-font-ubuntu twgtr-text-[20px] md:twgtr-text-[25px] twgtr-font-semibold twgtr-text-white">
													{rec6.recipe_title}
